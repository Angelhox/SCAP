...
public class frmEmpleado extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblEmpleados.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 0, true));
        tblEmpleados.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        ...
        tblEmpleados.setSelectionBackground(new java.awt.Color(52, 152, 219));
 ...
 private void inhabilitar() {
    ...
    void cargarTabla(String buscar, String criterioBusqueda, String criterioOrden, String orden) {
        try {
            ...
            fEmpleados funcEmpleados = new fEmpleados();
            modelo = funcEmpleados.mostrar(buscar, criterioBusqueda, criterioOrden, orden);
    ...
    void guardar() {
        if (txtCedula.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debes ingresar el número de cédula del usuario");
            txtCedula.requestFocus();
            return;
        }
        if (txtNombres.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Debes ingresar almenos un nombre del usuario");
        ...
        clsEmpleados dts = new clsEmpleados();
        fEmpleados funcEmpleados = new fEmpleados();
        ...
        if (accion.equals("nuevo")) {
            ...
            try {
                ...
                if (funcEmpleados.editar(dts)) {
                    JOptionPane.showConfirmDialog(rootPane, "Se ha actualizado el regsitro del usuario " + dts.getNombres() + dts.getApellidos());
                    cargarTabla("", "Apellidos", "Apellidos", "desc");
                      isActiveEditar=false;
                   isActiveNuevo=false;
                   inhabilitar();
    ...
    private void tblEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleadosMouseClicked
        ...
        txtCedula.setText(tblEmpleados.getValueAt(fila, 1).toString());
        txtNombres.setText(tblEmpleados.getValueAt(fila, 2).toString());
